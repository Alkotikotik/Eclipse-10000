# Eclipse-10000 [WIP]
This project aims to recreate full computer stack from the very scratch
*[x] 16-bit CPU on logisim using only logic gates
*[x] 32-bit CPU on system Verilog with Custom ISA
...
**The paper is at Eclipse_10000.pdf file**
